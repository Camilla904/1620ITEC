...
public class DVDCollection
{
      ...
      private int count; // tracks the size of the collection array; also in case increasing the size of the array is needed
      ...
      // store its reference in the collection array - increasing the 
      // size of the collection array if necessary. 
      //----------------------------------------------------------------- 
